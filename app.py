...
async def get_active_rules(channel: str = ""):
    ...
    When ?channel=<name> is supplied:
    - rules are filtered to that channel plus globals (channel == "")
    - refresh_interval comes from the channel's resolved override
    Otherwise the rule list is the full set and refresh_interval is the
    room-wide default.
    """
